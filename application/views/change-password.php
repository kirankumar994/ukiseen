		...
		<div class="col-md-9">
			...
			<div class="row">
		        ...
		        <div class="alert alert-success">
		            ...
		            <strong>Success!</strong> <?=$this->session->flashdata('password_success');?>
		        </div>
		        <?php endif; ?>
		        ...
		        <div class="alert alert-danger">
		            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
		            <strong>Failed!</strong> <?=$this->session->flashdata('password_error');?>
		        </div>
		        <?php endif; ?>
				   	<div class="form-group">
				   		<label>Old Password*</label>
	              		<input type="password" autocomplete="off" id="u_old" name="u_old" placeholder="Enter your old password" class="form-control login-field">
	              		<?=form_error('u_old');?>
	            	</div>
